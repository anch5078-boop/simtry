...
%(T assumed decreasing with x, hot wall at x=0). Identical convention
%to PCM_MATLAB/frontPosition.m (copied here so this folder is
%self-contained); see that file's header comment for why a strict
%T > Tm + tol test (rather than T >= Tm) is used.
%
%   xf = FRONTPOSITION(xc, T, Tm, tol)
%
